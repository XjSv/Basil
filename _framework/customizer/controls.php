    ...
    public function render_content() {
        ...
        if( empty( $this->menus ) )
	        ...
	        <label class="customize-control-select">
	            ...
	            <option value="">&mdash; <?php esc_html_e( 'Select', 'basil' ); ?> &mdash;</option>
	            <?php
 ...
 */
class WPC_Customize_Section_Heading extends WP_Customize_Control {
    ...
    public function render_content() {
       	?><div class="bx-customizer-section_heading"><?php echo esc_html( $this->label ); ?></h3><?php
    }
